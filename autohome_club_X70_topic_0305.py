...
'''
@author: Timz
@file: autohome_club_T5.py
@time: 2019/1/21 10:22
'''
...
def get_proxie():
    url = 'https://dps.kdlapi.com/api/getdps/?orderid=935193958194714&num=1&pt=1&sep=1'  # 在线API接口
    ...
    if topic:
        ...
        #楼主相关信息
            ...
            if user_from:
                ...
                print('来自：' + user_from)
                TopicInfo['user_from'] = user_from
            else:
                print('没有地区')
                TopicInfo['user_from'] = '未填写地区'
...
def save_to_csv(item):
    ...
    file_path = 'autohome_club_X70_topic.csv'
...
def get_one_url(page):
    #for x in page:
    url = 'https://club.autohome.com.cn/bbs/forum-c-4683-{}.html?orderby=dateline'.format(page)
    return url
